    ...
    Statement = [
      {
        ...
        Resource  = [
          ...
          "arn:aws:ssm:us-east-1:533267281718:parameter/roboshop.dev.payment.amqp_pass*",
          "arn:aws:ssm:us-east-1:533267281718:parameter/roboshop.dev.rabbitmq.amqp_pass*"
        ]
      }
    ]
  })
